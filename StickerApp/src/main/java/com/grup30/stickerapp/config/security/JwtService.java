...
public class JwtService {
    ...
    public JwtService(@Value("${application.security.jwt.secret-key}") String secretKey, ConfigService configService) {
    ...
    public String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        return Jwts
                ...
                .setExpiration(new Date(System.currentTimeMillis() + config.token_exp())) // 1 day
